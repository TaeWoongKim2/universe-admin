  ...
  return (
    <Box sx={styles.loginBox}>
      ...
      >
        ...
        >
          <AdminPanelSettingsOutlinedIcon color="secondary" fontSize="large" />
          Sign in
        </Typography>
